package ksmart.tourproject.user.board.controller;
...
import ksmart.tourproject.user.board.dto.UCategory;
import ksmart.tourproject.user.board.dto.UComment;
import ksmart.tourproject.user.board.dto.UCommunity;
import ksmart.tourproject.user.board.service.UCommunityService;
